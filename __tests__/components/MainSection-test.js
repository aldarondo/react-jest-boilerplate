...
jest.unmock('../../src/components/MainSection');
import MainSection from '../../src/components/MainSection'

jest.unmock('../../src/components/TodoItem');
import TodoItem from '../../src/components/TodoItem'

jest.unmock('../../src/components/Footer');
  ...
  describe('MainSection', () => {
    ...
    describe('toggle all input', () => {
      ...
      it('should call completeAll on change', () => {
        ...
        expect(props.actions.completeAll.mock.calls.length).toBe(1)
      })
    })
    ...
    describe('footer', () => {
      ...
      it('onClearCompleted should call clearCompleted', () => {
        ...
        expect(props.actions.clearCompleted.mock.calls.length).toBe(1)
      })
    })
